...
async def cmd_big_animation(message: types.Message):
    ...
    while True:
        ...
        # 3000+ emojis me se 9 random emojis
        ...
        try:
            ...
            # Telegram flood limits ko dhyan me rakhte hue
...
async def main():
    ...
    # Keep-alive task start
    asyncio.create_task(
        keep_alive()
    )

    print(
        "Bot + Flask + Keep-Alive "
        "are starting..."
    )
